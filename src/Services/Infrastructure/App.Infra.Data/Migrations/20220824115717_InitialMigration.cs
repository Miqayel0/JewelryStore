        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordHash = table.Column<string>(type: "varchar(4000)", nullable: false),
                    SecurityStamp = table.Column<string>(type: "varchar(4000)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Collection_Material_MaterialId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AccessTokenHash = table.Column<string>(type: "varchar(3000)", nullable: false),
                    RefreshTokenHash = table.Column<string>(type: "varchar(50)", nullable: false),
                    RefreshTokenHashSource = table.Column<string>(type: "varchar(3000)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItem_Collection_CollectionId",
                        column: x => x.CollectionId,
                        principalTable: "Collection",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItem_CollectionId",
                table: "OrderItem",
                column: "CollectionId");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "UserToken",
                column: "UserId")
                .Annotation("SqlServer:Include", new[] { "AccessTokenHash", "AccessTokenExpireDate", "RefreshTokenHash", "RefreshTokenHashSource" });
        }
